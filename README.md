# Data Visualization: Airline Route Profitability Analysis
 This project presents a time-series analysis of airline route profitability using Python, Pandas, and Matplotlib.
...
● Profit smoothing with two moving-average windows
● Volatility band
● Fill_between visualization using rolling mean ± standard deviation
● Normalized comparison
● Comparison of two periods on the same scale
● Annotated chart
